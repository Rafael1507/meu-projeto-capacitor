<script>
    ...
    let result = null;
    let fromUnit = 'pixels';
    let toUnit = 'polegadas';
  
    const units = ['pixels', 'polegadas'];
    const DPI = 96;
    ...
    function convertPixels() {
      ...
      let convertedValue;
      if (fromUnit === 'pixels' && toUnit === 'polegadas') {
        convertedValue = value / DPI;
      } else if (fromUnit === 'polegadas' && toUnit === 'pixels') {
        convertedValue = value * DPI;
      } else {
  ...
  <main class="container">
    ...
    <header>
      <h1>Conversor de Pixels para Polegadas</h1>
    ...
    <section class="converter">
      ...
      <button on:click={convertPixels}>Converter</button>
    </section>
